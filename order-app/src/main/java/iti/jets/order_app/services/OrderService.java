...
import iti.jets.order_app.interfaces.ProductsClient;
...
public class OrderService {
    ...
    public Object getProductByOrderIdFeignClient(Long orderId) {
        Order order = orderRepo.findById(orderId)
                .orElseThrow(() -> new RuntimeException("Order not found"));

        return productsClient.getProductByOrderId(order.getProductId());
    }
